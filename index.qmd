...
$$\text{cardiac_arrest}_i = \beta_0 + \beta_1  \text{intervention} + \epsilon_i $$
...
$$\text{cardiac_arrest}_i = \beta_0 + 
\beta_1  \text{intervention} + 
\beta_2  \text{cholesterol} + 
\beta_3 \text{smoking} + 
\epsilon $$

Where **intervention** is categorical (e.g., coded as 0/1) and **cholesterol** and **smoking** are a continuous variable
...
- Take the `nhefs` dataset as example, which contains data from [The National Health and Nutrition Examination Survey Data I Epidemiologic Follow-up Study (NHEFS)](https://vincentarelbundock.github.io/Rdatasets/articles/data.html).
